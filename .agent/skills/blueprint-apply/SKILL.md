...
- Read the relevant files in `blueprint/` and `openspec/changes/` before editing.
...
2. Read the relevant spec in `blueprint/` or `openspec/changes/`, `blueprint/design.md`, and current code files.
